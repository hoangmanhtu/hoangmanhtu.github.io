    ...
    <div class="container">
        <div class="col-sm-12">
            <div class="banner_noidung" style="text-align: center">
                ...
                <p ><?php echo $category["description"]; ?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="bread">
                    ...
                    <li> / </li>
                    <li>
                        <a href="danh-sach-san-pham"></i> Danh sách sản phẩm</a>
                    </li>
                    <li> / </li>
            ...
            <div class="col-sm-9">
                ...
                <ul class='pagination justify-content-center'>
                    ...
                    <?php  if($page > 1):
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo $category_link; ?>/<?php echo $prev_page;?>" aria-label="Previous">
                    ...
                    <?php for($i=1;$i<= $numPage;$i++):
                        if($i == $page): ?>
                            <li class="page-item  active">
                               <p class="page-link"><?php echo $i; ?></p>
                            </li>
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link " href="<?php echo $category_link; ?>/<?php echo $i ;?>"><?php echo $i ?></a>
                            </li>
                        <?php endif;
                    endfor; ?>
                    <?php   if($page < $numPage ):
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo $category_link; ?>/<?php echo $next_page ;?>" aria-label="Previous">
