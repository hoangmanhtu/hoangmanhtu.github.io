...
class Oder extends Model
{
    ...
    {
        $sql_insert= " Insert into orders(`user_id`,`fullname`,`address`,`mobile`,`email`,`note`,`price_total`,`payment_status`,`status`)  
                          values (:user_id,:fullname,:address,:mobile,:email,:note,:price_total,:payment_status,:status)";
